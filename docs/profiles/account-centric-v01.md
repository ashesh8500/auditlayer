...
/audits/new?account_id= (prefill handle/platform/memory, chip + HealthDot, cache badge "Research from DATE", force_refresh toggle, PDF opt-in checkbox DEFAULT OFF)
...
## PDF opt-in
0029: audits.pdf_requested bool default false. pipeline: pdf_status='pending' ONLY if pdf_requested else 'skipped'. pdf_worker guards. report-viewer: "Generate PDF" on-demand btn.
