...
5. `USER-STORIES.md` — partner, organization, member, founder, developer, commercial, and operational outcomes every idea must serve.
6. `PRODUCT-GROWTH-PORTFOLIO.md` — observable IAM, organization, seat, founder-sales, and funnel maturity; product-majority allocation for the next six waves.
7. `IDEA-QUEUE.md` — append-only proposed/in-flight work.
8. `LEDGER.md` — append-only verified, failed, partial, and parked verdicts.
