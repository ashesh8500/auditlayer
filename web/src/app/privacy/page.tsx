    ...
    <main className="mx-auto max-w-2xl px-6 py-16 text-sm leading-relaxed text-foreground">
      ...
      <section className="mt-8 space-y-4">
        ...
        <ul className="list-disc space-y-1 pl-5 text-muted-foreground">
          ...
          <li>
            <strong className="text-foreground">Instagram connection data</strong> — if you choose to connect your Instagram Business or Creator account, we store the minimum data needed (account ID, username, follower count) to pull live metrics for your reports.
          </li>
        </ul>
      </section>
      ...
      <Link
        href="/"
        className="mt-6 inline-block text-xs text-[color:var(--accent)] hover:underline"
      >
        ← Back to AuditLayerMedia
      </Link>
    </main>
