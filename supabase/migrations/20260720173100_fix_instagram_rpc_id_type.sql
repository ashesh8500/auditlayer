-- Correct the Instagram user id RPC type to match the canonical bigint column.
-- PostgREST accepts the OAuth API's numeric string without JavaScript precision loss.
